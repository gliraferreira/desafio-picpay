...
internal object StringGenerator {
    ...
    fun url(): String = "http://www.${getRandomElement(domains)}".toLowerCase()

    fun word(): String = getRandomElement(allWords)

    fun word(notIn: Set<String>): String = allWords.filterNot(notIn::contains).random()

    fun words(): String = words(rand.nextInt(maxWords - minWords) + minWords)

    fun words(count: Int): String = compose(count, Separator.SPACE.str, Separator.NONE.str) { word() }

    fun sentence(): String = sentence(rand.nextInt(maxWords - minWords) + minWords)
    ...
    fun sentences(): String = sentences(rand.nextInt(maxSentences - minSentences) + minSentences)

    fun sentences(sentences: Int): String = compose(
    ...
    fun paragraph(sentences: Int): String = compose(
        computeCount(sentences, minSentences, maxSentences),
        Separator.SPACE.str,
        Separator.NEWLINE.str
    ) { sentence() }

    fun paragraphs(): String = paragraphs(rand.nextInt(maxParagraphs - minParagraphs) + minParagraphs)

    fun paragraphs(paragraphs: Int): String = compose(
        computeCount(paragraphs, minParagraphs, maxParagraphs),
        Separator.NONE.str,
        Separator.NONE.str
    ) { paragraph() }

    fun firstName(): String = getRandomElement(firstNames)

    fun lastName(): String = getRandomElement(lastNames)

    fun name(): String = firstName() + Separator.SPACE.str + lastName()

    private fun emailDomain(): String = getRandomElement(emailDomains)
    ...
    private fun delimiter(): String = getRandomElement(emailDelimiters)
